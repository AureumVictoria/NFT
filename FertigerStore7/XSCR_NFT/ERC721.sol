...
import "./IBlacklist.sol";
    ...
    */
    contract ERC721 is Context, ERC165, IERC721, IERC721Metadata, Ownable{
        ...
        uint256 constant BLOCK_PER_YEAR = 10512000; 
    ...
    /**
     * @dev End URI for computing {tokenURI}. Empty by default, can be overriden
     * in child contracts.
     */
     ...
     * Activates the licence and calculates the end of the licence
     *
    ...
    function _mint(address to, uint256 tokenId) internal virtual {
        ...
        endLicence = balance + BLOCK_PER_YEAR;
    ...
    function _transfer(address from, address to, uint256 tokenId) internal virtual {
        ...
        require(whitelist.isWhitelisted(msg.sender) == true || whitelist.statusWhitelist() == false, "Not Whitelisted");
        require(blacklist.isBlacklisted(msg.sender) == false, "isBlacklisted");
